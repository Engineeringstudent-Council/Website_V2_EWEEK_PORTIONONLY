...
eweekApp.controller('EventListCtrl', function($scope, $routeParams) {
	$scope.events = [
		...
		{"name": "Milk and Cookies",
			...
			"description": "Start off E-Week by grabbing some milk and cookies and socializing with your fellow engineers at the Bechtel Terrace (right outside the ESS office). We will have an assortment of different cookies and they're free so be sure to come!",
			"tag": "Meet & Eat",
			"imgUrl": "img/milk.png"},
		...
		{"name": "Innovations in Engineering - Boeing",
			...
			"description": "A Boeing representative for 30 years, Mike O'Grady is a senior technical engineer.  Past positions covered propulsion systems, stress analysis, and structural materials development.  Mike manages Knowledge Based Engineering organization at Boeing and is responsible for developing tools that can cover cognitive routine work.",
			"tag": "Speakers",
			"imgUrl": "img/keynote.png"},
		{"name": "Interdepartamental Competition",
			...
			"dateTime":"All day!",
			"location": "Everywhere!",
			"description": "Which major is the best? Come to all the events! All competition scores count, as does student participation, having overall team spirit (cheering, best pickup line flawlessly delivered to an event coordinator), and volunteering at any of the events.   so make sure you come out to all the events and root for your department!",
			"tag": "Compete",
		...
		{"name": "Design & Build",
			...
			"description": "Put your engineering skills to the test! Engineering students will form teams and face off to overcome a unique design challenge to do some hands-on building! Competition details will be released at the beginning of the event. Dinner will be served! As with all competitions, there will be a prize for the team that best completes the design and build challenge. ",
			"tag": "Compete",
